...
hexo.extend.tag.register('stream', function(args, content){
  ...
  result += '.hexo-image-steam-lazy {display:block;}.hexo-img-stream{width: 23%;max-width: 1100px;margin: 3% 2% 0 0;float: left;box-shadow: 0 2px 2px #e5e5e5;}div.hexo-img-stream figure{margin:0 auto 10%;display:block;max-width:80%}div.hexo-img-stream figure img{border-bottom:0px solid #ccc;padding-bottom:0px;margin-bottom:0px}div.hexo-img-stream figure figcaption{font-size:.9rem;color:#444;line-height:1.5;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}div.hexo-img-stream small{font-size:1rem;float:right;text-transform:uppercase;color:#aaa}div.hexo-img-stream small a{color:#666;text-decoration:none;transition:.4s color}@media screen and (max-width:750px){.hexo-img-stream{column-gap:0}}';
  result += '</style>';
  result += content;
  result += '</div>';
